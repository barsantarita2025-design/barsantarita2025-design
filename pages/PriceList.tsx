  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-4">
        <div>
          <h2 className="text-3xl font-bold text-bar-text">Consulta de Precios</h2>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="block w-full pl-14 pr-4 py-4 bg-bar-800 border border-bar-600 rounded-xl text-bar-text placeholder-slate-500 focus:ring-2 focus:ring-bar-500 focus:border-transparent text-lg shadow-lg transition-all"
        ...
        {filteredProducts.map((product) => (
          ...
          >
            <div className="overflow-hidden">
              <h3 className="text-lg font-bold text-bar-text group-hover:text-bar-400 transition-colors">
                {product.name}
              </h3>
